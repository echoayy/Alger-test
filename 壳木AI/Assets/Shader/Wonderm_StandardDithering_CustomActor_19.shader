Shader "Wonderm/StandardDithering_CustomActor" {
	Properties {
		...
		_SimPower ("SimPower", Range(0.01, 2)) = 0.81
		...
		[HideInInspector] _Light_Num ("Light_Num", Float) = 0
		_Tattoo ("Tattoo", 2D) = "black" {}
		_TattooColor ("TattooColor", Vector) = (0,0,0,0)
